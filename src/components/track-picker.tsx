...
export function TrackPicker({ tracks }: { tracks: Track[] }) {
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="flex flex-col items-start justify-between gap-4 rounded-3xl border border-rule bg-white/70 px-6 py-5 sm:flex-row sm:items-center">
        ...
        <button
          ...
          className="rounded-full bg-coral px-6 py-2.5 text-sm font-semibold text-white shadow-[2px_2px_0_0_#b54e35] transition enabled:hover:bg-coral-dark disabled:cursor-not-allowed disabled:bg-ink/25 disabled:shadow-none"
        >
          Continue
        </button>
      </div>
